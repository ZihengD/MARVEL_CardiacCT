...
### STS-MIP visualization (Canon Aquilion ONE data)
...
MARVEL is an interpretable motion artifact reduction algorithm powered by a neural network-based motion estimation module.
